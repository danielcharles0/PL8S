...
import it.unipd.dei.webapp.wa001.database.restaurant.ListRestaurantDAO;
...
/**
 * A REST resource for listing {@link Restaurant}s. *
 */
@Deprecated
public final class ListRestaurantRR extends AbstractRR {
	 ...
	 */
	private static final String RESOURCE = "/rest/restaurants";
	 ...
	 */
	public ListRestaurantRR(final HttpServletRequest req, final HttpServletResponse res, Connection con) {
	...
	protected void doServe() throws IOException {
		...
		try {
			...
			LogContext.setResource(ListRestaurantRR.RESOURCE);

			// creates a new DAO for accessing the database and lists the restaurant(s)
			rl = new ListRestaurantDAO(con).access().getOutputParam();
