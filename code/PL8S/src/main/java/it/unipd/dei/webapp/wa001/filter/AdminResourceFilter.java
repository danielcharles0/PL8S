...
/**
 * Checks for successful authentication to allow for accessing admin resources.
 */
public class AdminResourceFilter implements Filter {

    /**
     * A LOGGER available for all the subclasses.
     */
    protected static final Logger LOGGER = LogManager.getLogger(AdminResourceFilter.class, StringFormatterMessageFactory.INSTANCE);
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain chain) throws
        ...
        try {
            ...
            LOGGER.error("Unable to perform the admin resource filtering.", e);
            throw e;
        } finally {
