		...
		<div class="content-container">
			<div class="content">
				<header class="with_buttons" >
					<h1 class="form_title">Edit Restaurant</h1>
					<div class="multiple_buttons">
						<input type="button" value="Delete" id="delete_button" class="section_button no_margin_button" />
						<input type="button" value="Save" id="save_button" class="section_button no_margin_button" />
					</div>
				</header>
				<%@include file="form-section.jsp" %>
			</div>
		</div>
		<script src="<c:url value="/js/restaurant/delete_restaurant.js" />"></script>
